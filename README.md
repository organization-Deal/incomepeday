...
ไม่มี KV namespace หรือ Queue; Cloudflare Cron เก็บสถานะราย 5 นาที และ CEM ใช้ SQLite Durable Object ดูแล session
...
### ชั่วโมงออนไลน์รายวัน

เปิด popup ของตู้หรือหน้ารายละเอียดเพื่อเลือกวันที่ดูออนไลน์/ออฟไลน์/ข้อมูลขาดหาย นับตามเวลาไทย 00:00 ถึงก่อน 00:00 วันถัดไป เป็นค่าประมาณจากรอบเก็บสถานะทุก 5 นาที ไม่ใช่เปอร์เซ็นต์ของรอบเช็คเดิมและไม่สร้างชั่วโมงย้อนหลังจากยอดเงิน

เมื่อ deploy เวอร์ชันนี้ Cron จะเริ่มบันทึกผ่าน `ONLINE_TIME` Durable Object โดยไม่ต้องเปิดเว็บ ตั้ง `ONLINE_TIME_ENABLED=false` เพื่อหยุดเก็บโดยรักษาประวัติเดิม หากห่างเกิน 10 นาทีหรืออ่านสถานะไม่ได้ ช่วงนั้นเป็นข้อมูลขาดหาย ไม่ถือว่าตู้ดับ Local preview ยังไม่มีตัวเก็บสถานะและจะแสดงว่ายังไม่มีประวัติ ดูรายละเอียดขีดจำกัด การปิดใช้งาน และการทดสอบใน [แผนชั่วโมงออนไลน์](docs/superpowers/plans/2026-09-16-daily-online-hours.md)

ตารางและ popup แสดงเวลาออนไลน์ล่าสุด ออฟไลน์ล่าสุด และเงินเข้าล่าสุดแยกกัน รายการเงินจริงของ CEM รับเฉพาะ `CASH`/`ONLINE` และตัดคำสั่งควบคุมเครื่องออก ส่วน EQLink เปรียบเทียบรายการมือถือ เงินสด และเหรียญ Cron กระจายการอ่านทีละ 5 ตู้ต่อรอบเพื่อลดภาระต้นทาง: EQLink ครบหนึ่งรอบภายในประมาณ 1 ชั่วโมง และ CEM ครบหนึ่งรอบภายในประมาณ 2 ชั่วโมง 5 นาที สำหรับกองปัจจุบัน ระหว่างรอรายการละเอียด หน้าเว็บแสดงยอดรายวันล่าสุดพร้อมป้ายว่าเป็นยอดรวมรายวันเพื่อไม่ทำให้เข้าใจว่าเป็นธุรกรรมเดียว
